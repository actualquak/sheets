...
public class SheetRenderer extends JComponent implements KeyListener {
    public SheetRenderer(SheetFrame frame) { throw new NotYetImplemented(); }
    public SheetRenderer(SheetFrame frame, SheetRegistry registry) { throw new NotYetImplemented(); }
