...
public class MarkAsTextAction extends MyAction {
    ...
    @SuppressWarnings("unused") public MarkAsTextAction(SheetRenderer renderer, SheetRegistry registry) {
        super("Text",
                null,
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        if(renderer.selection == null)
            registry.at(renderer.cursor, new LabelCell(registry.at(renderer.cursor).value()));
